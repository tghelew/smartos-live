...
// XXX-mg This can likely be lowered once we use large pages
...
exports.properties = {
    add_disks: {
        ...
        zonexml: 'zone.attr.app-svc-dependent'
    }, archive_on_delete: {
        loadValueTranslator: 'utils.fixBoolean',
        payload: {
            allowed: {
        ...
        payload: {
            allowed: {
                // XXX-mg don't know what cpu-type does
                'bhyve': ['create', 'receive', 'update'],
                'kvm': ['create', 'receive', 'update']
            },
            type: 'string'
        ...
        updatable: true,
        zonexml: 'zone.network.net-attr.gateways'
    }, 'nics.*.interface': {
        payload: {
            allowed: {
                'bhyve': ['add', 'update'],
        ...
        updatable: true,
        zonexml: 'zone.network.net-attr.ips'
    }, 'nics.*.mac': {
        payload: {
            allowed: {
                'bhyve': ['add', 'update'],
        ...
        payload: {
            allowed: {
                // XXX-mg need to figure out how this interacts with reboot
                'joyent': ['create', 'receive', 'update'],
                'joyent-minimal': ['create', 'receive', 'update'],
                'lx': ['create', 'receive', 'update']
            },
        ...
        // XXX-mg spice not supported with bhyve, I think.
        loadValueTranslator: 'utils.unbase64',
        payload: {
            allowed: {
                'kvm': ['create', 'receive', 'update']
        ...
        zonexml: 'zone.attr.zlog-max-size'
    }, zone_dataset_uuid: {
        payload: {
            allowed: {
                'bhyve': ['create', 'receive'],
...
exports.brand_options = {
    'bhyve': {
        ...
        'features': {
            ...
            'runtime_info': true,
            'zlogin_console': true,
            'type': 'KVM',              // XXX-mg intentional.  Good idea?
            'use_vm_autoboot': true,
            'use_vmadmd': true,
            'var_svc_provisioning': true,
            // XXX-mg need to implement this
        ...
        'features': {
            'brand_install_script': '/usr/lib/brand/lx/lx_install',
